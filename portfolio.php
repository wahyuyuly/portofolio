...
<html lang="en" id="home">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar fixed-top navbar-dark bg-dark">
        ...
        <a class="navbar-brand page-scroll" href="index.php">Wahyu Yuly Artha</a>
    ...
    <div class="jumbotron text-center">
    	<img src="https://storage.cloud.google.com/zahra-bucket/img/wahyu.jpg" class="rounded-circle">
    		...
    		<div class="row">
    			<div class="col-sm-4">
    				<a href="#" class="d-block mb-4 h-100">
    					<img class="img-fluid img-thumbnail" src="https://storage.cloud.google.com/zahra-bucket/img/portfolio/1.jpg">
    				</a>
    			</div>
    			<div class="col-sm-4">
    				<a href="#" class="d-block mb-4 h-100">
    					<img class="img-fluid img-thumbnail" src="https://storage.cloud.google.com/zahra-bucket/img/portfolio/2.jpg">
    				</a>
    			</div>
    			<div class="col-sm-4">
    				<a href="#" class="d-block mb-4 h-100">
    					<img class="img-fluid img-thumbnail" src="https://storage.cloud.google.com/zahra-bucket/img/portfolio/3.jpg">
    				</a>	
    			</div>	
    			<div class="col-sm-4">
    				<a href="#" class="d-block mb-4 h-100">
    					<img class="img-fluid img-thumbnail" src="https://storage.cloud.google.com/zahra-bucket/img/portfolio/4.jpg">
    				</a>	
    			</div>	
    			<div class="col-sm-4">
    				<a href="#" class="d-block mb-4 h-100">
    					<img class="img-fluid img-thumbnail" src="https://storage.cloud.google.com/zahra-bucket/img/portfolio/5.jpg">
    				</a>
    			</div>	
    			<div class="col-sm-4">
    				<a href="#" class="d-block mb-4 h-100">
    					<img class="img-fluid img-thumbnail" src="https://storage.cloud.google.com/zahra-bucket/img/portfolio/6.jpg">
    				</a>
    			</div>					
    		</div>	
    	</div>
	    		...
	    		<div class="col-sm-8 mx-auto">
	    			<form>
	    				...
	    				<div class="form-group">
	    					...
	    					<input type="mail" id="mail" class="form-control" placeholder="Masukkan Email">
	    				</div>
	    				<div class="form-group">
	    					<label for="telp">No Telepon</label>
	    					<input type="telp" id="telp" class="form-control" placeholder="Masukkan Nomor Telepon">
	    				</div>

	    				<select class="form-control">
	    					<option>-- Pilih Kategori --</option>
	    					<option>Jadwal Pertandingan</option>
	    					<option>Biodata Pemain</option>
	    				</select>
	    				<div class="form-group">
    ...
    <footer>
    	<div class="container text-center">
    		<div class="row">
    			<div class="col-sm-12">
    			<p>&copy; Copyright 2022 | built with passion<i class="glyphicon glyphicon-heart"></i> by. <a href="http://fb.com/wahyu chesya">Wahyu Yuly Artha</a>.</p>
    			</div>
    		</div>
    		<div class="row">
    			<div class="col-sm-12">
